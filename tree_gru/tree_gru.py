    ...
    def process_leafs(self,emb):
        ...
        with tf.variable_scope("Composition",reuse=True):
            ...
            def _recurseleaf(x):
                ...
                z,h_ = tf.split(concat_zh,2,axis = 1)
...
#cb : 600
            ...
            def _recurrence(node_h,idx_var):
                ...
                h,rl,rr,z=tf.split(tmp,4,axis = 1)
                ...
                h = (1-z) * h_ + tf.reduce_sum(z*child_h,[0])/2
            ...
            #     h = tf.reduce_sum(1-z,[0]) * h_ + tf.reduce_sum(z*child_h,[0])
