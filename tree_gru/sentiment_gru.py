...
def train(restore=False):
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            if restore:saver.restore(sess,'/home/vasilis/Desktop/thesis_scripts/weights/binary_gru_weights')
            for epoch in range(config.num_epochs):
                ...
                if dev_score > best_valid_score:
                    ...
                    saver.save(sess,'/home/vasilis/Desktop/thesis_scripts/weights/binary_gru_weights')
